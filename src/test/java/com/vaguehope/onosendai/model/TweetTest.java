...
public class TweetTest {
	...
	public void itConvertsToNiceLine () throws Exception {
		final Tweet t = new Tweet(null, null, "Their Name", "via foo", "via Foo Bar", "The tweet's body.", UTIME, null, null, null);
		assertEquals("\"The tweet's body.\" Their Name", t.toHumanLine());
	}

	@Test
	public void itConvertsToNiceParagraph () throws Exception {
		final Tweet t = new Tweet(null, "someone", "Their Name", "via foo", "via Foo Bar", "The tweet's body.", UTIME, null, null, null);
