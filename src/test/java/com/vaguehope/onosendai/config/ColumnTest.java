...
public class ColumnTest {
	...
	public void itRoundTrips () throws Exception {
		Column c = new Column(12, "title", new ColumnFeed("accountid", "resource"), 15, CollectionHelper.setOf(1, 2), false, NotificationStyle.DEFAULT, InlineMediaStyle.NONE, false);
	...
	public void itAddsAccountToLaterColumn () throws Exception {
		...
		final Column c = new Column(12, "title",
				...
				15, CollectionHelper.setOf(1, 2), false,
				NotificationStyle.DEFAULT, InlineMediaStyle.NONE, false);
	...
	public void itEqualsChecksExcludes () throws Exception {
		Column c = new Column(12, "title", new ColumnFeed("accountid", "resource"), 15, CollectionHelper.setOf(1, 2), false, NotificationStyle.DEFAULT, InlineMediaStyle.NONE, false);
		assertFalse(c.equals(new Column(12, "title", new ColumnFeed("accountid", "resource"), 15, CollectionHelper.setOf(1, 1), false, NotificationStyle.DEFAULT, InlineMediaStyle.NONE, false)));
	}

	@Test
	public void itEqualsChecksNotify () throws Exception {
		Column c = new Column(12, "title", new ColumnFeed("accountid", "resource"), 15, CollectionHelper.setOf(1, 2), false, NotificationStyle.DEFAULT, InlineMediaStyle.NONE, false);
		assertFalse(c.equals(new Column(12, "title", new ColumnFeed("accountid", "resource"), 15, CollectionHelper.setOf(1, 2), false, null, InlineMediaStyle.NONE, false)));
	}
	...
	public void itParsesComplexNotificationStyle () throws Exception {
		...
		Column c = new Column(12, "title", new ColumnFeed("accountid", "resource"), 15, CollectionHelper.setOf(1, 2), false, ns, InlineMediaStyle.NONE, false);
		String j = c.toJson().toString(2);
		Column c1 = Column.parseJson(j);
		assertEquals(c, c1);
	}
	...
	public void itDoesNotAllowNegativeIdsWhenParsingJson () throws Exception {
		try {
			Column.parseJson(new Column(-1, "title", new ColumnFeed("accountid", "resource"), 15, null, false, NotificationStyle.DEFAULT, InlineMediaStyle.NONE, false).toJson().toString(2));
		}
	...
	public void itDefaultsInlineMediaToFalse () throws Exception {
		JSONObject j = new Column(12, "title", new ColumnFeed("accountid", "resource"), 15, CollectionHelper.setOf(1, 2), false, NotificationStyle.DEFAULT, InlineMediaStyle.NONE, false).toJson();
	...
	public void itRoundtripsInlineMediaEnabled () throws Exception {
		JSONObject j = new Column(12, "title", new ColumnFeed("accountid", "resource"), 15, CollectionHelper.setOf(1, 2), false, NotificationStyle.DEFAULT, InlineMediaStyle.INLINE, false).toJson();
		Column c = Column.parseJson(j.toString(2));
		assertEquals(InlineMediaStyle.INLINE, c.getInlineMediaStyle());
	}

	public void itRoundtripsInlineMediaSeamless () throws Exception {
		JSONObject j = new Column(12, "title", new ColumnFeed("accountid", "resource"), 15, CollectionHelper.setOf(1, 2), false, NotificationStyle.DEFAULT, InlineMediaStyle.SEAMLESS, false).toJson();
		Column c = Column.parseJson(j.toString(2));
