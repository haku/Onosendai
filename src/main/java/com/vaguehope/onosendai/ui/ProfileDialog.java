...
public class ProfileDialog {
	...
	public static void show (final Context context, final Executor executor, final Account account, final String username) {
		final ProfileDialog pDlg = new ProfileDialog(context, username);
	...
	private ProfileDialog (final Context context, final String username) {
